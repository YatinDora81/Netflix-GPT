    ...
    <div className=" w-full flex justify-between items-center text-opacity-80  px-[6%] absolute top-[35%] md:top-0  aspect-video  bg-gradient-to-r text-white from-black ">
      <div className="flex flex-col gap-6 -translate-y-5">
        ...
        <div className="flex gap-2">
          <button onClick={()=>{navigate("/movie/"+now_playing_movie_res[0]?.id)}} className="bg-white text-black border border-black py-3 gap-1 px-6 rounded-xl font-bold text-xl  hover:opacity-90 transition flex justify-center items-center">
